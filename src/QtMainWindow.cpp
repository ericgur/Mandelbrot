...
QtMainWindow::QtMainWindow(QWidget* parent)
    : QMainWindow(parent)
    , m_centralWidget(new QMandelbrotWidget(this))
{
    ui.setupUi(this);
...
void QtMainWindow::onActionSaveImage()
{
    ...
    if (act == ui.actionSaveImage1920x1080) m_centralWidget->saveImage(1920, 1080);
    else if (act == ui.actionSaveImage2560x1440) m_centralWidget->saveImage(2560, 1440);
    else if (act == ui.actionSaveImage3840x2160) m_centralWidget->saveImage(3840, 2160);
}
...
void QtMainWindow::onActionPrecision()
{
    ...
    if (!act) return;
    // forward to widget with resolution based on action text
    if (act == ui.actionPrecisionAuto) m_centralWidget->setPrecision(QMandelbrotWidget::Precision::Auto);
    else if (act == ui.actionDouble) m_centralWidget->setPrecision(QMandelbrotWidget::Precision::Double);
    else if (act == ui.actionFixedPoint128) m_centralWidget->setPrecision(QMandelbrotWidget::Precision::FixedPoint128);
}
